...
const ProjectsPage = () => {
  const projects = [
    ...
    {
      title: "Understanding fairness judgments through computational cognitive modeling: Insights from the dictator game",
      journal: "Behavior Research Methods",
      year: "2024",
      authors: "Kim, W., Loosen, A.M., Gamond, L., Gu, X.",
      description: "Novel computational model of fairness judgments in the dictator game.",
      tags: ["Computational Modeling", "Fairness", "Social Decision-Making"],
