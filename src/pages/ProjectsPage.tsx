...
// Map images to corresponding projects. Keyed by index for easy mapping.
const projectImages = [
  "/lovable-uploads/b76e5773-501a-420b-aa42-b7d308812a38.png", // Rollwage et al. (first project with image)
  "/lovable-uploads/de21c4ef-14ed-4d5c-950f-9c5c8854f68f.png", // Towards a computational psychiatry...
                ...
                <div className="sm:w-48 flex-shrink-0 flex justify-center items-start p-4">
                  {index < projectImages.length ? (
                    <img
                      ...
                      className="object-contain w-full rounded-md border border-muted"
                      style={{ maxHeight: "144px", background: "#f9fafb" }}
                    />
                  ) : (
